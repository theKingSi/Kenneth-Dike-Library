        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 relative overflow-hidden">
            ...
            <AnimatePresence>
                {selectedImage && (
                    ...
                    >
                        <div className="relative w-full min-h-full flex flex-col lg:flex-row items-center justify-center p-4 sm:p-6 lg:p-8">
                            {/* Close Button */}
                            <button
                                className="fixed top-4 right-4 z-20 w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center text-white transition-colors duration-200"
                                onClick={() => setSelectedImage(null)}
                            >
                                <X className="h-5 w-5" />
                            </button>
                            ...
                            {/* Navigation Buttons */}
                            <button
                                className="fixed left-4 top-1/2 transform -translate-y-1/2 z-20 w-12 h-12 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center text-white transition-colors duration-200"
                                onClick={(e) => {
                                    e.stopPropagation()
                                    prevImage()
                                }}
                            ...
                            <button
                                className="fixed right-4 top-1/2 transform -translate-y-1/2 z-20 w-12 h-12 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center text-white transition-colors duration-200"
                                onClick={(e) => {
                                    e.stopPropagation()
                                    nextImage()
                                }}
                            ...
                            {/* Content Container */}
                            <motion.div
                                className="w-full max-w-7xl flex flex-col lg:flex-row gap-6 lg:gap-8 items-center lg:items-start"
                            ...
                            >
                                ...
                                <div className="w-full lg:w-96 lg:flex-shrink-0">
                                    <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 lg:p-8 shadow-2xl">
                                        ...
                                        <div className="text-gray-700 text-base lg:text-lg leading-relaxed mb-6 max-h-none overflow-visible">
                                            {selectedImage.description}
                                        </div>

                                        <div className="flex flex-col gap-3 text-sm lg:text-base text-gray-500 pt-4 border-t border-gray-200">
                                            <div className="flex items-center gap-2">
                                                <Calendar className="h-4 w-4 lg:h-5 lg:w-5 flex-shrink-0" />
                                                <span>{selectedImage.date}</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <Camera className="h-4 w-4 lg:h-5 lg:w-5 flex-shrink-0" />
